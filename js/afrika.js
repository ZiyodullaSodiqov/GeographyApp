...
var answerEghtOf = "Tanganika ko’li";
var answernineOf = "Namib cho’li";
var answertenOf = "Kalaxari";
var answerElevenOf = "Madakaskar oroli";
 ...
 function javoblar() {
    ...
    var afrikaInputs10 = document.getElementById('afrikaInputAnswer10').value;
    var afrikaInputs11 = document.getElementById('afrikaInputAnswer11').value;
    ...
    if(afrikaInputs10 == answertenOf){
        document.getElementById('afrikaInputAnswer10').style.backgroundColor = "#6ab04c";    
    }else{
        document.getElementById('afrikaInputAnswer10').style.backgroundColor = "#ff4d4d";
    }

    if(afrikaInputs11 == answerElevenOf){
        document.getElementById('afrikaInputAnswer11').style.backgroundColor = "#6ab04c";    
    }else{
        document.getElementById('afrikaInputAnswer11').style.backgroundColor = "#ff4d4d";
    }    
